 ...
 * 移動手段
 */
// abstract class と記述すると「抽象クラス」となります。
public abstract class Transportation {
   ...
   * @return
   */
  protected abstract String getTransportationName();
  ...
  public final boolean updateInfomation() {
    ...
    // checkTransportationCondition() メソッドは実装されていませんが、このように呼び出すことができます!
   ...
   * @return
   */
  // abstract がついているメソッドは「子クラス」で必ずオーバーライドしなければなりません。
  protected abstract int checkTransportationCondition();
